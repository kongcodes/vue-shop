...
export default {
  ...
  created() {
    ...
    this.$http.post("/category").then(res => {
  ...
  methods: {
    clickList(index) {
      ...
      // scrollTo(x, y, time, easing)  y传负数
      //   this.rightBscroll.scrollTo(0, -this.rightLiTops[index], 500, "easing");
      this.rightBscroll.scrollTo(0, -this.scrollY, 500, "easing");
    },
    // 初始化better-scroll
    _initBScroll() {
